...
export async function POST(request: NextRequest) {
  try {
    ...
    const prompt = `Analyzuj následující seznam léků pro možné interakce:
${medicationsList}
...
1. ŽÁDNÉ odborné termíny bez vysvětlení (ne "hyperkalemie", ale "příliš draslíku v krvi")
2. VŽDY vysvětli co to znamená pro běžný den člověka
3. KONKRÉTNÍ příznaky - ne "nevolnost", ale "pocit na zvracení, slabost"
4. PRAKTICKÉ rady - "užívejte ráno" místo "na lačný žaludek"
5. WARNINGS musí být kompletní věty s jasnou instrukcí kdy volat pomoc
6. Severity - PŘESNÉ DEFINICE:
